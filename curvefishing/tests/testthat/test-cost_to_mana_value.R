...
test_that("check replace_two_digit", {
    expect_equal(curvefishing:::replace_two_digit(string = c("9R", "10R", "11", "99")),
        expected = c("9R", "55R", "551", "55555555555555555554"))
})

test_that("check replace_hybrid", {
    expect_equal(curvefishing:::replace_hybrid(string = c("rw", "2rw", "1bgbg", "1brRrg")),
        expected = c("R", "2R", "1BB", "1BRR"))
    expect_equal(curvefishing:::replace_hybrid(string = c("rw", "2rw", "1bgbg", "1brRrg"), which = 2),
        expected = c("W", "2W", "1GG", "1RRG"))
    expect_equal(curvefishing:::replace_hybrid(string = c("rw", "2rw", "1bgbg", "1brRrg"), replacement = "1"),
